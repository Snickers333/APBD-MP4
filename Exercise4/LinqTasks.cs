...
namespace Exercise4
{
    public static class LinqTasks
    {
        ...
        {
            return Emps.Where(e => e.Job.Equals("Backend programmer"));
        }
        ...
        {
            return Emps.Where(e => e.Job.Equals("Frontend programmer") && e.Salary > 1000).OrderByDescending(e => e.Ename);
        }
        ...
        {
            return Emps.Join(Depts,e => e.Deptno,d => d.Deptno, (e, d) => new { Emp = e, Dept = d })
        ...
        public static IEnumerable<Dept> Task14()
        {
            return Depts.GroupJoin(
                            ...
                            d => d.Deptno,
                            e => e.Deptno,
                            (d, e) => new { Dept = d, Emps = e })
                        .Where(x => x.Emps.Count() == 5 || x.Emps.Count() == 0)
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(e => emps.Any(s => s.Mgr == e)).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
        }
